...
def proc_no_err(name, format, block):
    ...
    cv2.imwrite(PATH + "\\" + name + "\\" + "SU" + str(block_x) + ".bmp", decompressed_img)
...
def proc_simple_err(name, format, block, err_chance):
    ...
    cv2.imwrite(PATH + "\\" + name + "\\" + "addSimpleEr" + str(block_x) + ".bmp", decompressed_img)
...
def proc_gilbert_err(name, format, block, err_chance_min, err_chance_max, step_range):
    ...
    cv2.imwrite(PATH + "\\" + name + "\\" + "AddGilbertEr" + str(block_x) + ".bmp", decompressed_img)
